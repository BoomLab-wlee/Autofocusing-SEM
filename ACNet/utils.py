...
class Hyperparameters(object):
	def __init__(self):
		self.episodes = 3000  # episode 반복횟수
		self.batch_size = 2000 # 배치 크기
...
def get_clear_tensorboard():
    file_list = os.listdir("/home/leewj/projects/projects/[2020][COXEM]SEM_Autofocusing/ACNet/v2_supervised_learning/log_tensorboard")
    if file_list != None:
        for file in file_list:
            os.remove("/home/leewj/projects/projects/[2020][COXEM]SEM_Autofocusing/ACNet/v2_supervised_learning/log_tensorboard/%s" % (file))
